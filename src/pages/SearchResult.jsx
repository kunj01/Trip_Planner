...
const SearchResult = () => {
    ...
    // Effect to fetch search result for component from the 'searchPlaces' endpoint, effect is reran on change of 'location' state
    useEffect(() => {
        if (!location) {
            setIsLoading(false);
            setSearchResults([]);
        ...
        // Calling the 'searchPlaces' endpoint passing in the 'location', 'limit' parameter and 'source' for error handling
