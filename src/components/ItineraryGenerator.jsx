    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex justify-between items-center mb-4">
          <button onClick={() => setGeneratedItinerary(null)} className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
              ...
              {day.activities && day.activities.map((activity, actIndex) => (
                <div key={actIndex} className="mb-3 pl-4 border-l-2 border-blue-300">
                  ...
                  <div className="text-xs text-gray-500">
                    <span 
                      className="mr-3 cursor-pointer hover:text-blue-600 hover:underline transition-colors"
                      onClick={() => handleLocationClick(activity)}
                      title="Click to view on map"
                    >
                      📍 {activity.location}
                  ...
                  {day.meals.map((meal, mealIndex) => (
                    <div key={mealIndex} className="text-sm text-gray-600 mb-1">
                      ...
                      <span 
                        ...
                        onClick={() => handleLocationClick(meal)}
                        title="Click to view on map"
                      >
                        {meal.restaurant}
                      </span>
